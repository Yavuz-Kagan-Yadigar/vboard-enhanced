#!/usr/bin/env python3
"""
vboard — TR-Q virtual keyboard (Wayland / layer-shell build)
...
with a different layout the label will not match the character produced.
"""
import gi
import uinput
import os
...
# ponytail: sets Wayland app_id so Hyprland windowrule can match class:^(vboard)$
GLib.set_prgname("vboard")
...
key_mapping = {
    ...
    uinput.KEY_U: "U",  uinput.KEY_I: "ı",  uinput.KEY_O: "O",
    uinput.KEY_P: "P",
...
_TR_PAIRS = [("ğ", "Ğ"), ("ü", "Ü"), ("ş", "Ş"), ("ı", "I"), ("i", "İ"), ("ö", "Ö"), ("ç", "Ç")]
...
class VirtualKeyboard(Gtk.Window):
    def __init__(self):
        ...
        rows = [
            ...
            ["CapsLock", "A", "S", "D", "F", "G", "H", "J", "K", "L", "Ş", "i", ",", "Home"],
